  ...
  <div class="panel panel-default" style="margin-top: 10px">
    ...
    <div class="panel-body" style="margin-left: 60px">
    	<form action="php\factura_registro.php?accion=UDT" method="POST">
    		...
    		<div class="row">
    			<div class="col-md-5 col-md-offset-2 col-sm-4 col-sm-offset-2 col-lg-4 col-lg-offset-2 col-xs-12 col-xs-offset-0">
    			<div class="form-group">
				...
				<div class="col-md-5 col-md-offset-2 col-sm-5 col-sm-offset-2 col-lg-4 col-lg-offset-2 col-xs-12 col-xs-offset-2">
    			<div class="form-group">
